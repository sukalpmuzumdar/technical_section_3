...
$${AUROC=\frac {U} {{N}_{disease}*{{N}_{control}}}}$$ (where U is the Mann-Whitney test statistic - Hanley and McNeil, 1982)
...
Volcano plot to display top up- and down-regulated genes in disease state vs controls - uses a threshold of abs(log2FC) > 1.0 and adj. P-value < 0.05 to select genes which are DE. Also, genes which are assigned a NA adj. P value by DESeq2 are excluded (genes which did not pass independent filtering/have outliers as measured by Cook's distance)
